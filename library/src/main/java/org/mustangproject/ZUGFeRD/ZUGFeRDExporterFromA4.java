...
public class ZUGFeRDExporterFromA4 extends XRExporter implements IZUGFeRDExporter {
	private boolean isFacturX = true;

	public static final int DefaultZUGFeRDVersion = 2;
	protected boolean ignorePDFAErrors = false;

	public ZUGFeRDExporterFromA4 ignorePDFAErrors() {
		this.ignorePDFAErrors = true;
		return this;
	}

	protected PDFAConformanceLevel conformanceLevel = PDFAConformanceLevel.FOUR;
	 ...
	 */
	public ZUGFeRDExporterFromA4 load(String pdfFilename) throws IOException {
	...
	public ZUGFeRDExporterFromA4 setProfile(Profile p) {
		this.profile = p;
		if (xmlProvider != null) {
	...
	public ZUGFeRDExporterFromA4 setProfile(String profilename) {
	...
	public ZUGFeRDExporterFromA4 addAdditionalFile(String name, byte[] content) {
	 ...
	 */
	@Deprecated
	public ZUGFeRDExporterFromA4 setFacturX() {
		isFacturX = true;
		return this;
	}
	 ...
	 */
	public ZUGFeRDExporterFromA4 load(byte[] pdfBinary) throws IOException {
		ensurePDFIsValid(new ByteArrayDataSource(new ByteArrayInputStream(pdfBinary)));
		doc = Loader.loadPDF(pdfBinary);
		return this;
	}

	public ZUGFeRDExporterFromA4() {
		super();
		setZUGFeRDVersion(ZUGFeRDExporterFromA4.DefaultZUGFeRDVersion);
...
//		ef.addCompression();
	 ...
	 */
	public ZUGFeRDExporterFromA4 setXML(byte[] zugferdData) throws IOException {
	 ...
	 */
	public ZUGFeRDExporterFromA4 load(InputStream pdfSource) throws IOException {
	 ...
	 */
	public ZUGFeRDExporterFromA4 setConformanceLevel(PDFAConformanceLevel newLevel) {
		conformanceLevel = newLevel;
		return this;
	}


	public ZUGFeRDExporterFromA4 setCreator(String creator) {
		this.creator = creator;
		return this;
	}

	public ZUGFeRDExporterFromA4 setCreatorTool(String creatorTool) {
		this.creatorTool = creatorTool;
		return this;
	}

	public ZUGFeRDExporterFromA4 setProducer(String producer) {
		this.producer = producer;
		return this;
	}

	protected ZUGFeRDExporterFromA4 setAttachZUGFeRDHeaders(boolean attachHeaders) {
	...
	protected void writePDFAIdentificationSchema(XMPMetadata xmp) {
		...
		//not yet possible to set conformance level ("f")
		// java.lang.Error: org.apache.xmpbox.type.BadFieldValueException: The property given not seems to be a PDF/A conformance level (must be A, B or U)
	 ...
	 */
	public ZUGFeRDExporterFromA4 disableAutoClose(boolean disableAutoClose) {
	...
	public ZUGFeRDExporterFromA4 setZUGFeRDVersion(EStandard est, int version) {
	...
	@Override
	public ZUGFeRDExporterFromA4 setZUGFeRDVersion(int version) {
		this.ZFVersion = version;
		if (version == 1) {
			ZUGFeRD1PullProvider z1p = new ZUGFeRD1PullProvider();
			disableFacturX();
