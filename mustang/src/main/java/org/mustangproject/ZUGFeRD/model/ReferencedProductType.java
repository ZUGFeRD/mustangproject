...
public class ReferencedProductType {
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the unitQuantity property.
	 * <p>
	 * For example, to add a new item, do as follows: <pre>
	 *    getUnitQuantity().add(newItem);
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link QuantityType }
	 */
	public List<QuantityType> getUnitQuantity() {
		if (unitQuantity == null) {
			unitQuantity = new ArrayList<>();
		}
		return unitQuantity;
	}
