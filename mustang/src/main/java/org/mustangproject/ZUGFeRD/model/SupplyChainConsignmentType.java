...
public class SupplyChainConsignmentType {
	 ...
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the specifiedLogisticsTransportMovement property.
	 * <p>
	 * For example, to add a new item, do as follows: <pre>
	 *    getSpecifiedLogisticsTransportMovement().add(newItem);
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link LogisticsTransportMovementType }
	 */
