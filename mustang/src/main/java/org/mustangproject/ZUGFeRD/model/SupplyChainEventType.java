...
public class SupplyChainEventType {
	 ...
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the occurrenceDateTime property.
	 * <p>
	 * For example, to add a new item, do as follows: <pre>
	 *    getOccurrenceDateTime().add(newItem);
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link DateTimeType }
	 */
	public List<DateTimeType> getOccurrenceDateTime() {
		if (occurrenceDateTime == null) {
			occurrenceDateTime = new ArrayList<>();
		}
