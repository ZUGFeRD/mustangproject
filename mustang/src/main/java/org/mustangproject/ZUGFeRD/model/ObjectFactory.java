...
/**
 * This object contains factory methods for each Java content interface and Java element interface generated in the org.mustangproject.ZUGFeRD.model package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName CROSSINDUSTRYDOCUMENT_QNAME = new QName("urn:ferd:CrossIndustryDocument:invoice:1p0", "CrossIndustryDocument");
	...
	public JAXBElement<CrossIndustryDocumentType> createCrossIndustryDocument(CrossIndustryDocumentType value) {
		return new JAXBElement<>(CROSSINDUSTRYDOCUMENT_QNAME, CrossIndustryDocumentType.class, null, value);
	}
