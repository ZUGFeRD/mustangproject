...
public class TradeProductType {
	 ...
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the globalID property.
	 * <p>
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the applicableProductCharacteristic property.
	 * <p>
	 * For example, to add a new item, do as follows: <pre>
	 *    getApplicableProductCharacteristic().add(newItem);
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link ProductCharacteristicType }
	 */
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the designatedProductClassification property.
	 * <p>
	 * For example, to add a new item, do as follows: <pre>
	 *    getDesignatedProductClassification().add(newItem);
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link ProductClassificationType }
	 */
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the originTradeCountry property.
	 * <p>
	 * For example, to add a new item, do as follows: <pre>
	 *    getOriginTradeCountry().add(newItem);
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link TradeCountryType }
	 */
	public List<TradeCountryType> getOriginTradeCountry() {
		if (originTradeCountry == null) {
			originTradeCountry = new ArrayList<>();
		}
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the includedReferencedProduct property.
	 * <p>
	 * For example, to add a new item, do as follows: <pre>
	 *    getIncludedReferencedProduct().add(newItem);
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link ReferencedProductType }
	 */
