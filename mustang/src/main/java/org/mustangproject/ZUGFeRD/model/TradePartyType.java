...
public class TradePartyType {
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the definedTradeContact property.
	 * <p>
	 * For example, to add a new item, do as follows: <pre>
	 *    getDefinedTradeContact().add(newItem);
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link TradeContactType }
	 */
	public List<TradeContactType> getDefinedTradeContact() {
		if (definedTradeContact == null) {
			definedTradeContact = new ArrayList<>();
		}
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the specifiedTaxRegistration property.
	 * <p>
	 * For example, to add a new item, do as follows: <pre>
	 *    getSpecifiedTaxRegistration().add(newItem);
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link TaxRegistrationType }
	 */
	public List<TaxRegistrationType> getSpecifiedTaxRegistration() {
		if (specifiedTaxRegistration == null) {
			specifiedTaxRegistration = new ArrayList<>();
		}
