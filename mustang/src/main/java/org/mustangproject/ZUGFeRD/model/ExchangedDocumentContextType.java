...
public class ExchangedDocumentContextType {
	 ...
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the businessProcessSpecifiedDocumentContextParameter property.
	 * <p>
	 * For example, to add a new item, do as follows: <pre>
	 *    getBusinessProcessSpecifiedDocumentContextParameter().add(newItem);
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link DocumentContextParameterType }
	 */
	public List<DocumentContextParameterType> getBusinessProcessSpecifiedDocumentContextParameter() {
		if (businessProcessSpecifiedDocumentContextParameter == null) {
			businessProcessSpecifiedDocumentContextParameter = new ArrayList<>();
		}
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the guidelineSpecifiedDocumentContextParameter property.
	 * <p>
	 * For example, to add a new item, do as follows: <pre>
	...
	public List<DocumentContextParameterType> getGuidelineSpecifiedDocumentContextParameter() {
		if (guidelineSpecifiedDocumentContextParameter == null) {
			guidelineSpecifiedDocumentContextParameter = new ArrayList<>();
		}
